# Convertsions for tempature
# v1 - basic functionality - Fahrenheit, Celsius, Kelvin conversions
# by -Tim Cowan

#invalid_response set for while statment to loop until 'q' is entered to quit the program
invalid_response = None
while invalid_response != "q":

    #conversion_type = input("To convert temperature enter T|t or for currency conversion enter C|c : ").lower()
    #if conversion_type[0] == 't':
    ...
    # if conversion_type[0] == 'c':
    # else:
    #     invalid_response = input("Invalid entry type Q|q to quit or enter to continue").lower()
